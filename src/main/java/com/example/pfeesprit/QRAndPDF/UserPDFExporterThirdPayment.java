...
public class UserPDFExporterThirdPayment {
	

		   private List<Bill> listBills;
		   int priceincard;
		    
		   public UserPDFExporterThirdPayment(List<Bill> listBills, int priceincard) {
		   ...
		   public Document export(HttpServletResponse response) throws DocumentException, IOException {
		       ...
		       Paragraph s = new Paragraph("This is your third payment and the price in your loyalty card now is "+" "+priceincard+" TND");
		       document.add(s); 
