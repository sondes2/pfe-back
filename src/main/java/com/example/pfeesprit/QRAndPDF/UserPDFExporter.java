...
public class UserPDFExporter {
   ...
   public UserPDFExporter(List<Bill> listBills, int priceincard) {
   ...
   public Document export(HttpServletResponse response) throws DocumentException, IOException {
       ...
       Paragraph s = new Paragraph("Thank You For Your First Payment We Have Given You a LOYALTY CARD for that with price"+" "+priceincard);
